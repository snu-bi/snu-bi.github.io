...
<TD>&nbsp; </TD>
<TD BGCOLOR=WHITE><FONT SIZE=3><INPUT TYPE=TEXT NAME=title SIZE=58 VALUE="Re: P2P 공유 초보자 가이드-야동,영화,MP3 무료 공유" ></FONT>
<FONT SIZE=2>
<SELECT NAME=type >
	<OPTION VALUE=0 >TEXT
...
2003-09-03 04:17:09, &quot;초보가이드&quot; 님이 쓰신 글입니다.
&gt; P2P 공유 초보자 가이드-야동,영화,MP3 무료 공유
&gt; 
&gt; &quot;이거!! 내가 인터넷에서 받은건데~~&quot;
&gt; 주위에 이런 말을 한 번씩은 들어 보셨겠죠 ?
&gt; 
&gt; 인터넷에서는 간단히 검색어 입력만으로
&gt; 필요한 모든 것을 구할 수 있는 
&gt; P2P 공유 프로그램이라는게 있습니다.
&gt; 
&gt; 컴을 잘모르는 사람도 누구나 배울 수 있게 쉽게
&gt; 설명한 홈페이지를 소개합니다.
&gt; 
&gt; P2P 공유 초보자 가이드 
&gt; http://www.p2pkorea.ah.to">
