...
<TR>
<TD ALIGN=LEFT>
<A HREF="http://bi.snu.ac.kr/KDMS" TARGET=_self><IMG SRC=./img/ficon/mori2/home.gif ALT="홈" BORDER=0 WIDTH=31 HEIGHT=36></A><A HREF="/board/way-board.php?db=kdms&j=lv&pg=1&cv=&sf=&sd=&sw=" ><IMG SRC=./img/ficon/mori2/list.gif ALT="목록" BORDER=0 WIDTH=31 HEIGHT=36></A></TD>
</TR>
...
<TD>&nbsp; </TD>
<TD BGCOLOR=WHITE><FONT SIZE=3><INPUT TYPE=PASSWORD NAME=passwd SIZE=15 ></FONT>
&nbsp; &nbsp; <FONT CLASS=base COLOR=BLACK>수정/삭제시 필요</FONT></TD>
</TR>
...
<TR>
<TD BGCOLOR=WHITE ALIGN=RIGHT><FONT CLASS=base COLOR=BLACK>홈페이지</FONT></TD>
<TD>&nbsp; </TD>
<TD BGCOLOR=WHITE><FONT SIZE=3><INPUT TYPE=TEXT NAME=home SIZE=40 VALUE="http://" ></FONT></TD>
</TR>
...
<TD>&nbsp; </TD>
<TD BGCOLOR=WHITE><FONT SIZE=3><INPUT TYPE=TEXT NAME=title SIZE=58 VALUE="Re: 회원가입을 지금이라도 할 수 있는지...." ></FONT>
<FONT SIZE=2>
<SELECT NAME=type >
	<OPTION VALUE=0 >TEXT
...
2001-06-26 12:16:31, &quot;사무국&quot; 님이 쓰신 글입니다.
&gt; 일반 학회와 마찬가지로 언제나 가입할 수 있고, 혜택도 유사합니다. 
&gt; 
&gt; 학회 홈페이지(상기 URL을 클릭)를 참조하시기 바랍니다.
&gt; 
&gt; 2001-06-25 14:40:12, &quot;김진수&quot; 님이 쓰신 글입니다.
&gt; &gt; 데이터 마이닝에 관심이 많은 사람입니다.
&gt; &gt; 본 학회에서는 회원가입을 하면 어떤 혜택이 있습니까?
&gt; &gt; 그리고 지금도 회원가입이 가능한지 알고 싶습니다.">
...
function SubmitConfirm(form) {
	...
	if (form.passwd.value == "") {
		if (!confirm("암호 : 입력하지 않으면 글을 수정/삭제할 수 없습니다.\n\n계속하시겠습니까?")) {
		 	form.passwd.focus();
			return;
		}
	}
...
<INPUT TYPE=HIDDEN NAME=j  VALUE=twr>
