...
## {% include icon.html icon="fa-solid fa-bullseye" %}Course Description
...
## {% include icon.html icon="fa-solid fa-book" %}References

1. **Bayesian Time Series Models** — Barber, Cemgil & Chiappa — 2011
2. **Kalman Filtering and Neural Networks** — Haykin — 2001
3. **Beyond the Kalman Filter** — Ristic, Arulampalam & Gordon — 2004
